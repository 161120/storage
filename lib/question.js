...
module.exports = class Question extends Model {
	...
	static normalizeCreate(data) {
		data = _.pick(data, 'id', 'title', 'shortTitle', 'description', 'status', 'userId', 'answerType', 'answerVote', 'lang', 'country', 'category', 'createdAt', 'imageId', 'imageService');
	...
	static normalizeUpdate(data) {
		data = _.pick(data, 'id', 'title', 'description', 'status', 'category', 'countViews', 'imageId', 'imageService');
