...
module.exports = class Question extends Model {
	...
	static normalizeCreate(data) {
		data = _.pick(data, 'id', 'title', 'shortTitle', 'description', 'status', 'userId', 'answerType', 'answerVote', 'lang', 'country', 'type', 'createdAt', 'imageId', 'imageService', 'maxAnswers');
	...
	static normalizeUpdate(data) {
		data = _.pick(data, 'id', 'title', 'description', 'status', 'type', 'countViews', 'imageId', 'imageService', 'maxAnswers');
